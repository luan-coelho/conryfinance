        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row gap-3 mt-6">
            ...
            <Card className="md:w-5/12 h-full">
              <CardHeader className="bg-zinc-800 flex items-center justify-center text-center font-medium text-white rounded-t-xl rounded-b-3xl">
              ...
              <CardContent className="px-3 py-4">
                <div className="px-4">
                  <div className="flex items-center gap-2 flex-col">
                    <div className="flex items-center bg-green-100 border text-green-500 border-green-500 rounded-full px-2 py-1">
                  ...
                  <div className="flex items-center gap-2 flex-col">
                    <div className="flex items-center bg-red-100 border text-red-500 border-red-500 rounded-full px-2 py-1">
